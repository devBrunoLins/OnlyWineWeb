            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
                    <div class="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                        <h1 class="text-4xl font-medium tracking-tight text-gray-900">Find your next <span class="text-primary">adventure</span></h1>
                        <p class="mt-6 text-lg text-gray-600">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                        <div class="mt-8 flex flex-wrap gap-x-6 gap-y-4">
                            <a aria-label="Download on the App Store" class="rounded-lg transition-colors bg-gray-800 text-white hover:bg-gray-900" href="https://www.apple.com/br/search/tripmap?src=globalnav" target="_blank">
                                <svg viewBox="0 0 120 40" aria-hidden="true" class="h-10">
                            ...
                            <a class="inline-flex justify-center rounded-lg border py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm outline-2 outline-offset-2 transition-colors border-gray-300 text-gray-700 hover:border-gray-400 active:bg-gray-100 active:text-gray-700/80" href="https://www.youtube.com/@PogCastOficial" target="_blank">
                                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" class="h-6 w-6 flex-none">
                                    <circle cx="12" cy="12" r="11.5" stroke="#ff725e"></circle>
                                    <path d="M9.5 14.382V9.618a.5.5 0 0 1 .724-.447l4.764 2.382a.5.5 0 0 1 0 .894l-4.764 2.382a.5.5 0 0 1-.724-.447Z" fill="#ff725e" stroke="#ff725e"></path>
                                </svg>
                                <span class="ml-2.5 text-secondary">Watch the video</span>
                            </a>
                        </div>
                    </div>
                    <div class="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
                        ...
                        <div class="-mx-4 h-[448px] px-9 [mask-image:linear-gradient(to_bottom,white_60%,transparent)] sm:mx-0 lg:absolute lg:-inset-x-10 lg:-bottom-20 lg:-top-10 lg:h-auto lg:px-0 lg:pt-10 xl:-bottom-32">
                            <div class="relative aspect-[366/729] mx-auto max-w-[366px]">
                                ...
                                <div class="absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-default pt-[calc(23/318*100%)]">
                                        ...
                                        <div class="mt-6 flex-auto rounded-t-2xl bg-white">
                                            <div class="p-4">
                                                <div class="flex gap-2">
                                                    <div class="text-sm text-gray-900">Generated Routes</div>
                                                    <div class="text-xs leading-6 text-gray-500">(Statistic)</div>
                                                    <svg viewBox="0 0 24 24" class="ml-auto h-6 w-6" fill="none">
                                                        <path d="M5 12a7 7 0 1 1 14 0 7 7 0 0 1-14 0ZM12 9v6M15 12H9" stroke="#171717" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </svg>
                                                </div>
                                                <div class="mt-3 border-t border-gray-200 pt-5">
                                                    <div class="flex items-baseline gap-2">
                                                        <div class="text-2xl tabular-nums tracking-tight text-gray-900">753.00</div>
                                                        <!-- <div class="text-sm text-gray-900">USD</div> -->
                                                        <div class="ml-auto text-sm tabular-nums tracking-tight text-primary">last month</div>
                                                    </div>
                                                    <div class="mt-6 flex gap-4 text-xs text-gray-500">
                                                        <div>1D</div>
                                                        <div>5D</div>
                                                        <div class="font-semibold text-primary">1M</div>
                                                        <div>6M</div>
                                                        <div>1Y</div>
                                                        <div>5Y</div>
                                                    </div>
                                                    <div class="mt-3 rounded-lg bg-gray-50 ring-1 ring-inset ring-black/5">
                                                        <svg viewBox="0 0 286 208" class="overflow-visible">
                                                            <defs>
                                                                ...
                                                                <linearGradient id=":R79a5m:-gradient" x1="0" x2="0" y1="0" y2="1">
                                                                    <stop offset="0%" stop-color="#a3a3a3"></stop>
                                                                    <stop offset="100%" stop-color="#a3a3a3" stop-opacity="0"></stop>
                                                                </linearGradient>
                                                            </defs>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0" y1="34.666666666666664" x2="286" y2="34.666666666666664"></line>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0" y1="69.33333333333333" x2="286" y2="69.33333333333333"></line>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0" y1="104" x2="286" y2="104"></line>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0" y1="138.66666666666666" x2="286" y2="138.66666666666666"></line>
                                                            <line stroke="#a3a3a3" opacity="0.1" x1="0" y1="173.33333333333331" x2="286" y2="173.33333333333331"></line>
                                                            <rect y="32" width="270px" height="144" fill="url(#:R79a5m:-gradient)" clip-path="url(#:R79a5m:-clip)" opacity="0.5"></rect>
                                                            <path d="M 16.0000 32.0000L 23.9375 47.4709L 31.8750 39.3576L 39.8125 80.0116L 47.7500 63.6279L 55.6875 79.3140L 63.6250 87.8140L 71.5625 98.9128L 79.5000 71.6366L 87.4375 127.3372L 95.3750 120.1308L 103.3125 112.3023L 111.2500 120.2355L 119.1875 144.6337L 127.1250 176.0000L 135.0625 162.2326L 143.0000 144.3634L 150.9375 152.3953L 158.8750 144.6221L 166.8125 129.9535L 174.7500 103.3517L 182.6875 112.3401L 190.6250 136.2645L 198.5625 129.6337L 206.5000 120.0959L 214.4375 153.2965L 222.3750 136.5233L 230.3125 143.7035L 238.2500 132.5581L 246.1875 159.0494L 254.1250 144.2413L 262.0625 127.0233L 270.0000 103.2209" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" pathLength="1" stroke-dashoffset="0px" stroke-dasharray="1px 1px" stroke="#06b6d4"></path>
                                                        </svg>
                                                    </div>
                                                    <div class="mt-4 rounded-lg bg-cyan-500 px-4 py-2 text-center text-sm font-semibold text-white">Trade</div>
