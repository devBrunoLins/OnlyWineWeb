                ...
                <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
                    <div style="width: 44vw;" class="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                        ...
                        <div class="mt-8 flex flex-wrap gap-x-6 gap-y-4">
                            <a aria-label="Download on the App Store" class="inline-flex items-center justify-center rounded-lg transition-colors bg-black text-white hover:bg-gray-900 px-4 py-2.5" href="https://www.apple.com/br/search/tripmap?src=globalnav" target="_blank">
